...
DVSC will fail to connect if you get multiple WWW-Authenticate headers. It is due to a bug in the client itself. [isOnPrem not passed down correctly when invoking GetAuthorityFromTargetServiceAsync � Issue #396 � microsoft/PowerPlatform-DataverseServiceClient (github.com)](https://github.com/microsoft/PowerPlatform-DataverseServiceClient/issues/396).
